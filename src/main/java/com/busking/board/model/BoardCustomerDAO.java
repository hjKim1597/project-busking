...
public class BoardCustomerDAO {
	...
	public static BoardCustomerDAO getInstance() { // static 같은 곳에서 사용
		return instance;
	}
	...
	public ArrayList<BoardCustomerDTO> getList() {
		...
		try {
			...
			while (rs.next()) {
				...
				// 25. 한번에 생성자로 집어넣기
				BoardCustomerDTO dto = new BoardCustomerDTO(bno, writer, title, content, regdate, hit);

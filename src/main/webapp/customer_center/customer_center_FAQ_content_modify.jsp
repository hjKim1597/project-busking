            ...
            <div class="col-xs-12 col-sm-12 col-lg-12 col-lg-12 board">
                <div class="service-board">
                    <div class="container">
						...
						<!-- 글 업데이트 -->
                        <form action="updateFAQ.customer?faqNum=${dto.faqNum }" method="post" class="form">
							...
							<div class="board_button_set" style="text-align: right">
                                <div class="board-button" style="display: inline; padding: 8px;">
                                    <a href="${pageContext.request.contextPath }/customer_center/customer_center_FAQ.customer" style="display: inline;

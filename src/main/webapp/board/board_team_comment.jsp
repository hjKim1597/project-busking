...
<head>
	...
	<!-- 댓글 css 링크 -->
	<link rel="stylesheet" href="${pageContext.request.contextPath }/resources/css/board/board_team_comment.css">
	    ...
	    <div class="board_comment_inner">
	        ...
	        <div class="board_comment_list"> <!--댓글 리스트 영역-->
	        	<c:forEach var="dto" items="${commentList }">
		            <c:choose>
		            	<c:when test="${dto.comTeamReply == 'ROOT' }">
		            		<div class="board_comment_list_box">
				                ...
				                <div class="comment-section" style="display: none">
						            <form action="board_comment_team_reply.comment" method="post">
				                        <div class="comment">
				                            ...
				                            <input type="hidden" value="${dto.comTeamNum }" name="reply">

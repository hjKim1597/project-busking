...
<head>
<meta charset="UTF-8">
<link rel="stylesheet" href="../resources/css/board_css/board_news_write.css">
    ...
    <div class="board_write_box">
        ...
        <form class="board_write_content" action="submit.php" method="post">
            ...
            <div class="button_box">
                ...
                <button type="submit" class="button_registration" onclick="location.href='board_news_list.jsp'">등록</button>
            </div>
        </form>
    </div>
</section>

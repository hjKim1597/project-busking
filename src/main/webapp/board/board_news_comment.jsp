	    ...
	    <div class="board_comment_inner">
	        ...
	        <div class="board_comment_list"> <!--댓글 리스트 영역-->
	        	<c:forEach var="dto" items="${commentList }">
		            <c:choose>
		            	<c:when test="${dto.comNewsReply == 'ROOT' }">
		            		<div class="board_comment_list_box">
				                <div class="board_comment_header">
				                    ...
				                    <button class="board_comment_like" onclick="location.href='board_comment_like.comment?comNum=${dto.comNewsNum}'">
				                ...
				                <div class="comment-section" style="display: none">
						            <form action="board_comment_news_reply.comment" method="post">
				                        <div class="comment">
				                            ...
				                            <input type="hidden" value="${dto.comNewsNum }" name="reply">
